...
local function new_view(root, x, y, ps)
    ...
    local core_temp = DataIndicator{parent=reactor,x=2,y=3,lu_colors=lu_col,label="堆芯温度:",unit=db.temp_label,format="%10.2f",value=0,commas=true,width=26,fg_bg=text_fg}
    local burn_r    = DataIndicator{parent=reactor,x=2,y=4,lu_colors=lu_col,label="燃烧速率:",unit="mB/t",format="%10.2f",value=0,width=26,fg_bg=text_fg}
    local heating_r = DataIndicator{parent=reactor,x=2,y=5,lu_colors=lu_col,label="升温速率:",unit="mB/t",format="%12.0f",value=0,commas=true,width=26,fg_bg=text_fg}
    ...
    TextBox{parent=reactor_fills,text="燃料",x=2,y=1,fg_bg=text_fg}
    TextBox{parent=reactor_fills,text="冷却",x=2,y=2,fg_bg=text_fg}
    TextBox{parent=reactor_fills,text="热冷却",x=2,y=4,fg_bg=text_fg}
    TextBox{parent=reactor_fills,text="废料",x=2,y=5,fg_bg=text_fg}

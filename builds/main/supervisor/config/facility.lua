...
TextBox{parent=fac_c_10,x=30,y=9,text="new!",fg_bg=cpair(colors.red,colors._INHERIT)}
...
TextBox{parent=fac_c_11,x=27,y=11,text="new!",fg_bg=cpair(colors.red,colors._INHERIT)}
...
TextBox{parent=fac_c_12,x=29,y=4,text="new!",fg_bg=cpair(colors.red,colors._INHERIT)}

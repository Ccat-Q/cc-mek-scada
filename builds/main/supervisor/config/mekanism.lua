...
TextBox{parent=mek_c_1,x=33,y=7,text="新!",fg_bg=cpair(colors.red,colors._INHERIT)}
...
TextBox{parent=mek_c_2,x=string.len(key[3])+17,y=field.get_y(),text="新!",fg_bg=cpair(colors.red,colors._INHERIT)}
end
...
TextBox{parent=mek_c_3,x=38,y=5,text="新!",fg_bg=cpair(colors.red,colors._INHERIT)}
...
TextBox{parent=mek_c_3,x=38,y=6,text="新!",fg_bg=cpair(colors.red,colors._INHERIT)}

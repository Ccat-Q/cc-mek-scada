...
TextBox{parent=mtx_div,y=1,text="感应矩阵",alignment=ALIGN.CENTER}
...
local energy  = PowerIndicator{parent=mtx_div,y=11,lu_colors=lu_col,label="充能:",unit=db.energy_label,format="%8.2f",value=0,width=21,fg_bg=text_fg}
local avg_chg = PowerIndicator{parent=mtx_div,lu_colors=lu_col,label="\xb7均:",unit=db.energy_label,format="%8.2f",value=0,width=21,fg_bg=text_fg}
local input   = PowerIndicator{parent=mtx_div,lu_colors=lu_col,label="入:",unit=db.energy_label,format="%8.2f",rate=true,value=0,width=21,fg_bg=text_fg}
local avg_in  = PowerIndicator{parent=mtx_div,lu_colors=lu_col,label="\xb7均:",unit=db.energy_label,format="%8.2f",rate=true,value=0,width=21,fg_bg=text_fg}
local output  = PowerIndicator{parent=mtx_div,lu_colors=lu_col,label="出:",unit=db.energy_label,format="%8.2f",rate=true,value=0,width=21,fg_bg=text_fg}
local avg_out = PowerIndicator{parent=mtx_div,lu_colors=lu_col,label="\xb7均:",unit=db.energy_label,format="%8.2f",rate=true,value=0,width=21,fg_bg=text_fg}
...
PushButton{parent=mtx_div,x=9,y=18,text="更多",min_width=6,fg_bg=cpair(colors.lightGray,colors.gray),active_fg_bg=cpair(colors.gray,colors.lightGray),callback=mtx_ext_page.nav_to}
PushButton{parent=mtx_ext_div,x=9,y=18,text="返回",min_width=6,fg_bg=cpair(colors.lightGray,colors.gray),active_fg_bg=cpair(colors.gray,colors.lightGray),callback=matrix_page.nav_to}
TextBox{parent=mtx_ext_div,y=1,text="更多矩阵信息",alignment=ALIGN.CENTER}
local chging = IconIndicator{parent=mtx_ext_div,y=3,label="充能中",states=wht_ind_s}
local dischg = IconIndicator{parent=mtx_ext_div,y=4,label="放电中",states=wht_ind_s}
TextBox{parent=mtx_ext_div,text="能量填充",y=6,width=13,fg_bg=label}
...
local max_io = IconIndicator{parent=mtx_ext_div,y=8,label="最大入/出速率",states=yel_ind_s}
TextBox{parent=mtx_ext_div,text="输入利用率",y=10,width=13,fg_bg=label}
...
TextBox{parent=mtx_ext_div,text="输出利用率",y=11,width=13,fg_bg=label}
...
TextBox{parent=mtx_ext_div,text="容量（"..db.energy_label.."）",y=13,fg_bg=label}
...
TextBox{parent=mtx_ext_div,text="最大入/出（"..db.energy_label.."/t）",y=15,fg_bg=label}

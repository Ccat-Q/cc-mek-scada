--
-- SCADA Simulator Configuration
--
-- Lightweight command-line configuration for the simulator. Writes
-- /sim.settings (CraftOS settings API). Kept intentionally simple and
-- dependency-free so the simulator stays small.
--
...
-- CraftOS built-in globals (not in the luacheck globals list)
local print = print -- luacheck: ignore
local read = read -- luacheck: ignore
...
---@param default any
---@param is_number boolean? true to parse as number
---@return any value
